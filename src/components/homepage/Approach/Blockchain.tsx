...
import BackgroundPNG from "images/homepage/approach/blockchain-background.webp"
import BlockchainSVG from "images/homepage/approach/Blockchain.svg"
...
export default function Blockchain({ timeline }: BlockChainProps) {
  ...
  useAnimation(() => {
    if (svg.current && timeline) {
      ...
      // remove the green when expanding diagram
  ...
  return (
    <Wrapper>
      ...
      <Intersection
        ...
        ref={intersection}
        src={IntersectionSVG}
        alt="a green triangle highlighting the intersection of the three Venn Diagrams"
      />
    </Wrapper>
  )
}

const BG = styled(BlockchainSVG)`
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
