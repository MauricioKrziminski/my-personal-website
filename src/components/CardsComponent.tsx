...
export function CardsComponent() {
  return (
    <div className="grid cursor-default grid-cols-2 gap-4 md:grid-cols-3">
      <div className="min-h-32 min-w-32 transform overflow-hidden rounded-xl bg-zinc-300 shadow-2xl transition duration-300 hover:scale-105 hover:border hover:border-white hover:bg-blue-700 lg:min-h-64 lg:min-w-56">
        <div className="p-4">
